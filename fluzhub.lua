-- FluzHub v2.5 | [⚔️DUELS] | by: jesuslmk
...
-- Ventana Principal del Hub (Neon Minimalista)
...
-- COMBAT: SILENT AIM CON RAYCAST TEAM & WALL CHECK
...
-- Hookeo dinámico de puntería para Silent Aim
...
-- ANIMS: SISTEMA COMPLETO DE ANIMATION PACKS (Ninja, Toy, Zombie, Levitacion, Adidas)
			...
			if animateScript then
				local anims = {
					["Ninja"] = {
						...
						walk = {"656121766", "656121766"},
						run  = {"656118839", "656118839"},
						jump = {"656117878", "656117878"},
						fall = {"656115606", "656115606"},
						swim = {"656116490", "656116490"}
					},
					["Toy"] = {
						idle = {"782841498", "782841498"},
						walk = {"782845736", "782845736"},
						run  = {"782842759", "782842759"},
						jump = {"782847020", "782847020"},
						fall = {"782843345", "782843345"},
						swim = {"782844575", "782844575"}
					},
					["Zombie"] = {
						idle = {"616158929", "616158929"},
						walk = {"616168032", "616168032"},
						run  = {"616163682", "616163682"},
						jump = {"616161997", "616161997"},
						fall = {"616160354", "616160354"},
						swim = {"616165520", "616165520"}
					},
					["Levitation"] = {
						idle = {"707829716", "707829716"},
						walk = {"707823501", "707823501"},
						run  = {"707826189", "707826189"},
						jump = {"707817789", "707817789"},
						fall = {"707814984", "707814984"},
						swim = {"707821611", "707821611"}
					},
					["Adidas"] = {
						idle = {"12635419566", "12635419566"},
						walk = {"10681050834", "10681050834"},
						run  = {"10681050834", "10681050834"},
						jump = {"11571549528", "11571549528"},
						fall = {"9399340635", "9399340635"},
						swim = {"10653799381", "10653799381"}
					}
				}
				...
				if selected then
					for _, folder in pairs(animateScript:GetChildren()) do
						if folder:IsA("StringValue") and selected[folder.Name:lower()] then
							local idList = selected[folder.Name:lower()]
							local i = 1
							for _, child in pairs(folder:GetChildren()) do
								if child:IsA("Animation") then
									child.AnimationId = "rbxassetid://" .. (idList[i] or idList[1])
									i = i + 1
								end
							end
						end
